...
android {
    namespace = "com.zaro.xboxrumble"; compileSdk = 34
    defaultConfig { applicationId = "com.zaro.xboxrumble"; minSdk = 26; targetSdk = 34; versionCode = 1; versionName = "1.0" }
...
dependencies {
    ...
    implementation(libs.androidx.ui); implementation(libs.androidx.ui.graphics); implementation(libs.androidx.ui.tooling.preview)
